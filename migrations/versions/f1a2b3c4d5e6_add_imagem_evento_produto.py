"""add link_imagem to evento and imagem_nome to produto
...
def upgrade() -> None:
    ...
    op.add_column("produto", sa.Column("imagem_nome", sa.Text(), nullable=True))


def downgrade() -> None:
    """Downgrade schema."""
    op.drop_column("produto", "imagem_nome")
